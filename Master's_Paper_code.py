...
lda_overall=models.LdaModel(overallcorpus, num_topics=20, passes=50, id2word=overalldict)
...
lda_library=models.LdaModel(libcorpus, num_topics=10, passes=50, id2word=librarydict)
...
lda_nonlibrary=models.LdaModel(nonlibcorpus, num_topics=10, passes=50, id2word=nonlibrarydict)
